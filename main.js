...
const App = (() => {
    ...
    const initElements = () => {
        ...
        if (currentPage === 'login.html') {
            ...
            elements = {
                ...
                base64Converter: document.getElementById('base64Converter'),
    ...
    const init = () => {
        ...
        if (currentPage === 'login.html') {
            ...
            if (elements.base64Converter) elements.base64Converter.addEventListener('click', () => navigateTo('base64_converter.html'));
